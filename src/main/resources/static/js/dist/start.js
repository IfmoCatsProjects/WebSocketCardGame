...
function EnterForm(props) {
  ...
  const send = e => {
    ...
    response.onload = () => {
      ...
      if (text.status === "not found") document.getElementById("error-enter").innerText = text.text;else window.location.pathname = "/";
    };
  };
...
function RegForm(props) {
  ...
  const {
    setData,
    setPage
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(Object(function webpackMissingModule() { var e = new Error("Cannot find module '../app'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
  const send = e => {
    e.preventDefault();
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/main/resources/static/js/start/startUtils.js");
/******/ 	
/******/ })()
;
